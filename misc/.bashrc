...
__conda_setup="$('/home/fenil/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
...
export PATH="$PATH:/opt/firefox/firefox:$PATH"
...
# change_background() { dconf write /org/mate/desktop/background/picture-filename "'/home/mpaulson/dotfiles/backgrounds/$(ls ~ /dotfiles/backgrounds | fzf)'" }
